...
namespace P9_714220030.view
{
    public partial class FormTransaksiBarang : Form
    {
        ...
        private void harga_TextChanged_1(object sender, EventArgs e)
        {
            FormatDigit(harga);
        }
        ...
        private void qty_TextChanged_1(object sender, EventArgs e)
        {
            TotalHarga();
        }

        private void id_barang_SelectedIndexChanged_1(object sender, EventArgs e)
        {
